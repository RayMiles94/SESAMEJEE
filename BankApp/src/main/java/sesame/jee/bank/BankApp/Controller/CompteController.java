...
public class CompteController {
	...
	@PostMapping("/co/add")
	public String postcompte(Model model, @RequestParam("client") String c, @RequestParam("employees") String employees,
			@RequestParam("solde") String solde, @RequestParam("ctype") String ctype,
			@RequestParam("decouvertb") String decouvertb, @RequestParam("update") String update,
